...
//
	...
	@Override
	public Result charge(Contact contact, ChargeParameter chargeParameter) throws StripeException {
		...
		return new SuccessResult ("Basarili bir sekilde odeme tamamlandi");
	}
